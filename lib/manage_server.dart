...
class _ManageServerPageState extends State<ManageServerPage> {
  ...
  Future<void> _fetchVpsList() async {
    ...
    final uri = Uri.parse('http://yakuza.omdhangantenk.my.id.omdhangantenk.web.id:2003/myServer?key=${widget.keyToken}');
    try {
  ...
  Future<void> _addVps() async {
    ...
    final uri = Uri.parse('http://yakuza.omdhangantenk.my.id.omdhangantenk.web.id:2003/addServer');
    try {
  ...
  Future<void> _deleteVps(String host) async {
    final uri = Uri.parse('http://yakuza.omdhangantenk.my.id.omdhangantenk.web.id:2003/delServer');
    try {
      final res = await http.post(uri, body: {
        'key': widget.keyToken,
        'host': host,
